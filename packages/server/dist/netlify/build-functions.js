...
async function bundleFunctions() {
    try {
        ...
        const prismaClientPath = resolve(__dirname, "../../node_modules/.pnpm/@prisma+client@5.22.0_prisma@5.22.0/node_modules/@prisma/client");
        if (!existsSync(prismaClientPath)) {
            throw new Error(`Prisma Client directory not found at ${prismaClientPath}`);
        }
        ...
        const outputFiles = readdirSync(resolve(__dirname, "../../../netlify/functions"));
